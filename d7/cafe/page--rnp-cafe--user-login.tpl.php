          ...
          <div id="secondary-menu" class="navigation container-inline fio">
            ...
            <div id="secondary-menu-block" class="block">
              <ul id="secondary-menu-links" class="links inline">
                ...
                <li class="sitemap">
                  <?php print l('<img src="' . base_path() . drupal_get_path('theme', 'sitepublico') . '/img/sitemap.png" />', 'sitemap', array('html' => TRUE)) ?>
                </li>
      ...
      <div id="main" class="clearfix">
        <div id="content">
          <div class="section">
            ...
            <div id="login-cafe">
              <h1 class="title">Acesso federado</h1>
              <div id="login-cafe-wrapper">
                <img src="<?php print base_path() . drupal_get_path('theme', 'sitepublico') ?>/img/cafe-logo.jpg" />
                <?php print drupal_render(drupal_get_form('shib_auth_form_form')); ?>
              </div>
              <div id="login-cafe-info">
                Para utilizar a identificação por meio da CAFe, sua instituição deve aderir a esse serviço provido pela Rede Nacional de Ensino e Pesquisa (RNP). <a href="#">Saiba mais</a>
              </div>
            </div>
            <div id="login-user">
              <h1 class="title">Acesso não federado</h1>
              <?php if ($tabs): ?>
